...
# (str) Package name
package.name = investmentGrowthProjector
...
source.include_exts = py,jpg,html,js,css,ico,txt

# (list) List of inclusions using pattern matching
source.include_patterns = static/*,static/css/*,static/js/*,templates/*,main.py
...
presplash.filename = static/icon.jpg

# (str) Icon of the application
icon.filename = static/icon.jpg
